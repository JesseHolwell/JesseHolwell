    ...
    function(u, p) {
        var d = {},
            ...
            b = w.Latin1 = {
                ...
                parse: function(a) {
                    for (var c = a
                        ...
                        j = 0;
                        j < c;
                        j++) e[j >>> 2] |= (a.charCodeAt(j) & 255) << 24 - 8 * (j % 4);
            ...
            x = w.Utf8 = {
                ...
                parse: function(a) { return b.parse(unescape(encodeURIComponent(a))) }
            },
...
(function(u) {
    ...
    for (var t = CryptoJS, r = t.lib, w = r.WordArray, v = r.Hasher, r = t.algo, b = [], x = 0;
        64 > x;
        x++
...
CryptoJS.lib.Cipher ||
    function(u) {
        ...
        q = (p.pad = {}).Pkcs7 = {
            pad: function(a, b) {
                for (var c = 4 * b, c = c - a.sigBytes % c, d = c << 24 | c << 16 | c << 8 | c, l = [], n = 0;
                    n < c;
                    n += 4) l.push(d);
                c = s.create(l, c);
                a.concat(c)
