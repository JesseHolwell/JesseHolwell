        ...
        function() {
            return function(scope, element, attrs) {
                ...
                if (angular.isString(val) && val.length === 0) { //empty attribute
                    ...
                    attrs.$observe("ngAnimateChildren",
                        function(value) {
...
// "OR" statement then it would not be enough to catch that.
                ...
                function($window,
                    ...
                    return function init(element, options) {
                        ...
                        if (options.stagger > 0) {
                            ...
                            stagger =
                                computeCachedCssStaggerStyles(node,
                                    preparationClasses,
                                    cacheKey,
    ...
    var $$AnimateCssDriverProvider = [
        "$$animationProvider", function($$animationProvider) {
            ...
            this.$get = [
                "$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document",
                    ...
                    function prepareFromToAnchorAnimation(from, to, classes, anchors) {
                        ...
                        return {
                            start: function() {
                                ...
                                $$AnimateRunner.all(animationRunners,
                                    function(status) {
...
//  by the time...
                            ...
                            forEach(animations,
                                function(ani) {
                                    ...
                                    operations.push(function() {
                                        ...
                                        endProgressCb = executeAnimationFn(animation,
                                            element,
                                            event,
                                            options,
                                            function(result) {
                        ...
                        function packageAnimations(element, event, options, animations, fnName) {
                            ...
                            if (operations.length === 0) {
                                ...
                                if (fnName === "beforeSetClass") {
                                    a =
                                        groupEventedAnimations(element,
                                            "removeClass",
                                            options,
                                            animations,
                                            "beforeRemoveClass");
    ...
    var $$AnimateJsDriverProvider = [
        "$$animationProvider", function($$animationProvider) {
            ...
            this.$get = [
                "$$animateJs", "$$AnimateRunner", function($$animateJs, $$AnimateRunner) {
                    return function initDriverFn(animationDetails) {
    ...
    var $$AnimateQueueProvider = [
        "$animateProvider", function($animateProvider) {
            ...
            rules.skip.push(function(element, newAnimation, currentAnimation) {
                ...
                return currentAnimation.structural &&
            ...
            rules.cancel.push(function(element, newAnimation, currentAnimation) {
                ...
                return (nO.addClass && nO.addClass === cO.removeClass) ||
                    (nO.removeClass && nO.removeClass === cO.addClass);
            });

            this.$get = [
                "$$rAF", "$rootScope", "$rootElement", "$document", "$$HashMap",
                ...
                function($$rAF,
                    ...
                    function queueAnimation(element, event, options) {
                        ...
                        if (!isValidAnimation) {
                            ...
                            isValidAnimation = (newAnimation.event === "animate" &&
            ...
            this.$get = [
                ...
                function($$jqLite, $rootScope, $injector, $$AnimateRunner, $$HashMap, $$rAFScheduler) {
                    ...
                    return function(element, event, options) {
                        ...
                        var classes = mergeClasses(element.attr("class"),
                        ...
                        $rootScope.$$postDigest(function() {
                            ...
                            forEach(groupedAnimations,
                                function(animationEntry) {
                                    toBeSortedAnimations.push({
                                        domNode:
                                            getDomNode(animationEntry.from
