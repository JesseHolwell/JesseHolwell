                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        if (!this.$element.find(".bs-title-option").length) {
                            ...
                            if ($(element.options[element.selectedIndex])
                                .attr("selected") ===
                                undefined) titleOption.selected = true;
                        }
                    }
                        ...
                        if (isOptgroup && $this.data("divider") !== true) {
                            ...
                            if ($this.index() === 0) { // Is it the first option of the optgroup?
                                ...
                                var label = this.parentNode.label,
                                    labelSubtext = typeof $this.parent().data("subtext") !== "undefined"
                                        ? '<small class="text-muted">' + $this.parent().data("subtext") + "</small>"
                                        : "",
...
// Is it NOT the first option of the select && are there elements in the dropdown?
                            ...
                            _li.push(generateLI(generateA(text, "opt " + optionClass + optGroupClass, inline, tokens),
                                index,
                                "",
                                optID));
                            ...
                            _li
                                .push(generateLI(generateA(text, optionClass, inline, tokens),
                                    index,
                                    "hidden is-hidden"));
                        } else {
                ...
                render: function(updateLi) {
                    ...
                    var selectedItems = this.$element.find("option").map(function() {
                        if (this.selected) {
                            ...
                            (this
                                .disabled ||
                                this.parentNode.tagName === "OPTGROUP" && this.parentNode.disabled)) return;
                    ...
                    if (this.multiple && this.options.selectedTextFormat.indexOf("count") > -1) {
                        ...
                        if ((max.length > 1 && selectedItems.length > max[1]) ||
                            ...
                            var totalCount = this.$element.find("option")
                                    .not('[data-divider="true"], [data-hidden="true"]' + notDisabled).length,
                                tr8nText = (typeof this.options.countSelectedText === "function")
                                    ? this.options.countSelectedText(selectedItems.length, totalCount)
                                    : this.options.countSelectedText;
                            title = tr8nText.replace("{0}", selectedItems.length.toString())
                    ...
                    if (!title) {
                        title = typeof this.options.title !== "undefined"
                            ? this.options.title
                    ...
                    if (this.options.size === "auto") {
                        var getSize = function() {
                            ...
                            if (that.options.dropupAuto) {
                                that.$newElement
                                    .toggleClass("dropup",
                                        selectOffsetTop > selectOffsetBot && (menuHeight - menuExtras) < getHeight);
                            }
                ...
                clickListener: function() {
                    ...
                    this.$newElement.on("touchstart.dropdown",
                        ".dropdown-menu",
                        function(e) {
                            e.stopPropagation();
                        });
                    ...
                    this.$button.on("click",
                        function() {
                            that.setSize();
                            that.$element.on("shown.bs.select",
                                function() {
                                    if (!that.options.liveSearch && !that.multiple) {
                                        ...
                                        var offset = that.$lis.eq(selectedIndex)[0].offsetTop -
                            ...
                            if (!that.isDisabled() && !$this.parent().hasClass("disabled")) {
                                    ...
                                    if (maxOptions !== false || maxOptionsGrp !== false) {
                                        ...
                                        if ((maxOptions && maxReached) || (maxOptionsGrp && maxReachedGrp)) {
                                            if (maxOptions && maxOptions == 1) {
                                                ...
                                                if (maxOptionsArr[2]) {
                                                    maxTxt = maxTxt
                                                        .replace("{var}", maxOptionsArr[2][maxOptions > 1 ? 0 : 1]);
                                                    maxTxtGrp = maxTxtGrp
                                                        .replace("{var}", maxOptionsArr[2][maxOptionsGrp > 1 ? 0 : 1]);
                                                }
                                ...
                                if ((prevValue != that.$element.val() && that.multiple) ||
                                    ...
                                    that.$element.trigger("changed.bs.select",
                                        [clickedIndex, $option.prop("selected"), state]);
                                }
                            }
                        });
                        ...
                        function() {
                            if (that.$searchbox.val()) {
                                ...
                                if (that.options.liveSearchNormalize) {
                                    ...
                                    $searchBase = $searchBase
                                        .not(":" + that._searchStyle() + '("' + that.$searchbox.val() + '")');
                                }
                                ...
                                that.$lis.filter(".dropdown-header").each(function() {
                                    ...
                                    if (that.$lis.filter("[data-optgroup=" + optgroup + "]").not($this).not(".hidden")
                                        .length ===
                                        0) {
                                ...
                                if (!that.$lis.not(".hidden, .no-results").length) {
                                    ...
                                    $no_results.html(that.options.noneResultsText
                                        .replace("{0}", '"' + htmlEscape(that.$searchbox.val()) + '"')).show();
                ...
                keydown: function(e) {
                    ...
                    if (that.options.liveSearch) {
                        if (/(^9$|27)/.test(e.keyCode.toString(10)) &&
                            isActive &&
                        ...
                        if (!$this.val() && !/(38|40)/.test(e.keyCode.toString(10))) {
                            if ($items.filter(".active").length === 0) {
                                ...
                                if (that.options.liveSearchNormalize) {
                                    ...
                                    $items = $items
                                        .filter(":" + that._searchStyle() + "(" + keyCodeMap[e.keyCode] + ")");
                                }
                            }
                        }
                    }
                    ...
                    if (/(38|40)/.test(e.keyCode.toString(10))) {
                        ...
                        $items.each(function() {
                            if (!$(this).hasClass("disabled")) {
                                if ($.trim($(this).children("a").text().toLowerCase()).substring(0, 1) ==
