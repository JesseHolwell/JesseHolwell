    ...
    L.DomUtil = {
        ...
        removeClass: function(el, name) {
            if (el.classList !== undefined) {
                ...
                L.DomUtil._setClass(el,
                    L.Util.trim((" " + L.DomUtil._getClass(el) + " ").replace(" " + name + " ", " ")));
            }
        },
 ...
 */
    ...
    L.Map = L.Class.extend({
        ...
        _initEvents: function(onOff) {
            ...
            var events = [
                    "dblclick", "mousedown", "mouseup", "mouseenter",
        ...
        _onResize: function() {
            ...
            this._resizeRequest = L.Util.requestAnimFrame(
                function() { this.invalidateSize({ debounceMoveend: true }); },
                this,
                false,
                this._container);
        },
        ...
        unproject: function(point) { // (Point, Boolean) -> LatLng
            ...
            while ((Math.abs(dphi) > tol) && (--i > 0)) {
                ...
                dphi = (Math.PI / 2) -
                    2 *
                    Math.atan(ts *
                        Math.pow((1.0 - con) / (1.0 + con), 0.5 * eccent)) -
                    phi;
                phi += dphi;
            }
 ...
 */
    ...
    L.Path = L.Browser.svg || !L.Browser.vml
        ? L.Path
        : L.Path.extend({
            statics: {
                VML: true,
 ...
 */
    ...
    L.Path = (L.Path.SVG && !window.L_PREFER_CANVAS) || !L.Browser.canvas
        ? L.Path
        : L.Path.extend({
            statics: {
 ...
 */
    ...
    L.extend(L.DomEvent,
    {
        ...
        removeDoubleTapListener: function(obj, id) {
            ...
            if (L.Browser.pointer) {
                document.documentElement.removeEventListener(L.DomEvent.POINTER_CANCEL,
                    obj[pre + this._touchend + id],
                    false);
            }
 ...
 */
    ...
    L.PosAnimation = L.Class.extend({
        ...
        run: function(el, newPos, duration, easeLinearity) { // (HTMLElement, Point[, Number, Number])
            ...
            el.style[L.DomUtil.TRANSITION] = "all " +
                (duration || 0.25) +
                "s cubic-bezier(0,0," +
                (easeLinearity || 0.5) +
                ",1)";
