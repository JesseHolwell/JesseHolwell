...
[
    "ui.bootstrap.collapse", "ui.bootstrap.tabindex", "ui.bootstrap.accordion", "ui.bootstrap.alert",
    "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.isClass",
    "ui.bootstrap.datepicker", "ui.bootstrap.position", "ui.bootstrap.datepickerPopup", "ui.bootstrap.debounce",
    "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap", "ui.bootstrap.modal", "ui.bootstrap.paging",
    "ui.bootstrap.pager", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover",
    "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker",
        ...
        function() {
            return {
                ...
                link: function(scope, element, attrs, controller) {
                    scope.$watch(function() { return controller[attrs.uibAccordionTransclude]; },
                        function(heading) {
                            if (heading) {
                ...
                link: function(scope, element, attrs, ctrls) {
                    ...
                    element.on(buttonsCtrl.toggleEvent,
                        function() {
                            ...
                            scope.$apply(function() {
                                ngModelCtrl.$setViewValue(element.hasClass(buttonsCtrl.activeClass)
                                    ? getFalseValue()
                                    : getTrueValue());
                                ngModelCtrl.$render();
                            });
            ...
            return {
                beforeAddClass: function(element, className, done) {
                    if (className === "active") {
                        ...
                        var removeClassFn = removeClass.bind(this,
                            element,
    ...
    [
        "$log", "$locale", "dateFilter", "orderByFilter", function($log, $locale, dateFilter, orderByFilter) {
            ...
            this.init = function() {
                ...
                formatCodeToRegex = [
                    ...
                    },
                    {
                        ...
                        apply: function(value) {
                            this.month = $locale.DATETIME_FORMATS.STANDALONEMONTH
                                .indexOf(value);
                        },
            ...
            function createParser(format) {
                ...
                angular.forEach(formatCodeToRegex,
                    function(data) {
...
angular.module("ui.bootstrap.datepicker", ["ui.bootstrap.dateparser", "ui.bootstrap.isClass"])
    ...
    [
        ...
        function($scope,
            ...
            [
                ...
                case "maxDate":
                case "minDate":
                    $scope.$watch("datepickerOptions." + key,
                        function(value) {
                            if (value) {
                ...
                case "minMode":
                    if ($scope.datepickerOptions[key]) {
                        $scope.$watch(function() { return $scope.datepickerOptions[key]; },
                            function(value) {
            ...
            if (angular.isDefined($attrs.ngDisabled)) {
                watchListeners.push($scope.$parent.$watch($attrs.ngDisabled,
                    function(disabled) {
            ...
            this.init = function(ngModelCtrl_) {
                ...
                if ($scope.datepickerOptions.initDate) {
                    self.activeDate = dateParser
                        .fromTimezone($scope.datepickerOptions.initDate, ngModelOptions.timezone) ||
                        new Date();
                    $scope.$watch("datepickerOptions.initDate",
                        function(initDate) {
            ...
            $scope.select = function(date) {
                if ($scope.datepickerMode === self.minMode) {
                    var dt = ngModelCtrl.$viewValue
                        ? dateParser.fromTimezone(new Date(ngModelCtrl.$viewValue), ngModelOptions.timezone)
    ...
    [
        "$scope", "$element", "dateFilter", function(scope, $element, dateFilter) {
        ...
        "$document", "$window", function($document, $window) {
            ...
            return {
                ...
                positionElements: function(hostElem, targetElem, placement, appendToBody) {
                    ...
                    targetElemPos.placement = placement[1] === "center"
                        ? placement[0]
...
angular.module("ui.bootstrap.datepickerPopup", ["ui.bootstrap.datepicker", "ui.bootstrap.position"])
    ...
    [
        ...
        "$uibPosition", "dateFilter", "uibDateParser", "uibDatepickerPopupConfig", "$timeout", "uibDatepickerConfig",
        ...
        function($scope,
            ...
            this.init = function(_ngModel_) {
                ...
                if (datepickerPopupConfig.html5Types[$attrs.type]) {
                    ...
                    $attrs.$observe("uibDatepickerPopup",
            ...
            $scope.isDisabled = function(date) {
                ...
                var dates = {};
                angular.forEach(["minDate", "maxDate"],
                    function(key) {
                        if (!$scope.datepickerOptions[key]) {
                            dates[key] = null;
...
angular.module("ui.bootstrap.dropdown", ["ui.bootstrap.position"])
    ...
    [
        "$scope", "$element", "$attrs", "$parse", "uibDropdownConfig", "uibDropdownService", "$animate", "$uibPosition",
            ...
            scope.$watch("isOpen",
                function(isOpen, wasOpen) {
                    ...
                    if (hasOpenClass === !isOpen) {
                        ...
                        ](openContainer, appendTo ? appendToOpenClass : openClass).then(function() {
                    ...
                    if (isOpen) {
                        if (self.dropdownMenuTemplateUrl) {
                            $templateRequest(self.dropdownMenuTemplateUrl).then(function(tplContent) {
                                ...
                                $compile(tplContent.trim())(templateScope,
        ...
        function() {
            return {
                ...
                link: function(scope, element, attrs, dropdownCtrl) {
                    ...
                    scope.$watch(dropdownCtrl.isOpen,
                        function(isOpen) {
        ...
        function($animate, $injector, $modalStack) {
            ...
            function linkFn(scope, element, attrs) {
                if (attrs.modalInClass) {
                    ...
                    scope.$on($modalStack.NOW_CLOSING_EVENT,
            ...
            $modalStack.loadFocusElementList = function(modalWindow) {
                if (modalWindow) {
                    ...
                    if (modalDomE1 && modalDomE1.length) {
                        ...
                        return elements
                            ? Array.prototype.filter.call(elements,
                                function(element) {
    ...
    .provider("$uibModal",
        function() {
            var $modalProvider = {
                ...
                $get: [
                    "$rootScope", "$q", "$document", "$templateRequest", "$controller", "$uibResolve", "$uibModalStack",
                    function($rootScope, $q, $document, $templateRequest, $controller, $uibResolve, $modalStack) {
                        ...
                        $modal.open = function(modalOptions) {
                            ...
                            if (modalOptions.component) {
                                templateAndResolvePromise = $q
                                    .when($uibResolve.resolve(modalOptions.resolve, {}, null, null));
                            } else {
                                templateAndResolvePromise =
                                    $q.all([
                                        getTemplatePromise(modalOptions), $uibResolve
                                        .resolve(modalOptions.resolve, {}, null, null)
                                    ]);
                            }
                ...
                create: function(ctrl, $scope, $attrs) {
                    ...
                    ctrl.init = function(ngModelCtrl, config) {
                        ...
                        if ($attrs.itemsPerPage) {
                            ctrl._watchers.push($scope.$parent.$watch($attrs.itemsPerPage,
                                function(value) {
...
angular.module("ui.bootstrap.pager", ["ui.bootstrap.paging", "ui.bootstrap.tabindex"])
    ...
    [
        "$scope", "$attrs", "uibPaging", "uibPagerConfig", function($scope, $attrs, uibPaging, uibPagerConfig) {
    ...
    .directive("uibPager",
    [
        "uibPagerConfig", function(uibPagerConfig) {
            return {
                scope: {
                    totalItems: "=",
                    previousText: "@",
        ...
        function($scope, $attrs, $parse, uibPaging, uibPaginationConfig) {
            ...
            var maxSize = angular.isDefined($attrs.maxSize)
                ...
                pageLabel = angular.isDefined($attrs.pageLabel)
                    ? function(idx) { return $scope.$parent.$eval($attrs.pageLabel, { $page: idx }); }
                    : angular.identity;
            ...
            if ($attrs.maxSize) {
                ctrl._watchers.push($scope.$parent.$watch($parse($attrs.maxSize),
                    function(value) {
...
//need to replace ellipsis when the buttons would be sequential
    ...
    [
        "$parse", "uibPaginationConfig", function($parse, uibPaginationConfig) {
            return {
                scope: {
                    totalItems: "=",
                    firstText: "@",
 ...
 */
    .provider("$uibTooltip",
        function() {
             ...
             */
            this.$get = [
                "$window", "$compile", "$timeout", "$document", "$uibPosition", "$interpolate", "$rootScope", "$parse",
                "$$stackedMap", function($window,
                    $compile,
                    $timeout,
                    $document,
                    $position,
                            ...
                            compile: function(tElem, tAttrs) {
                                ...
                                return function link(scope, element, attrs, tooltipCtrl) {
                                            ...
                                            positionTimeout = $timeout(function() {
                                                    var ttPosition = $position
                                                        .positionElements(element,
                                                            ...
                                                            appendToBody);
                                                    var initialHeight =
                                                        angular.isDefined(tooltip.offsetHeight)
                                                    ...
                                                    if (!tooltip
                                                        .hasClass(options.placementClassPrefix + ttPosition.placement)
                                                    ) {
                                                        tooltip
                                                            .removeClass(options.placementClassPrefix + lastPlacement);
                                                        tooltip
                                    ...
                                    function prepareTooltip() {
                                        ...
                                        ttScope
                                            .placement = angular.isDefined(attrs[prefix + "Placement"])
                                        ...
                                        ttScope
                                            .popupCloseDelay =
                                            !isNaN(closeDelay) ? closeDelay : options.popupCloseDelay;
                                    }
        ...
        function($animate, $sce, $compile, $templateRequest) {
            return {
                link: function(scope, elem, attrs) {
                    ...
                    scope.$watch($sce.parseAsResourceUrl(attrs.uibTooltipTemplateTransclude),
                        function(src) {
                            ...
                            if (src) {
                                ...
                                $templateRequest(src, true).then(function(response) {
                                        ...
                                        var clone = $compile(template)(newScope,
                                            function(clone) {
 ...
 */
    ...
    [
        "$uibTooltip", function($uibTooltip) {
    ...
    [
        "$uibTooltip", function($uibTooltip) {
            return $uibTooltip("uibTooltipTemplate",
                "tooltip",
                "mouseenter",
                {
                    useContentExp: true
    ...
    [
        "$uibTooltip", function($uibTooltip) {
            return $uibTooltip("uibTooltipHtml",
                "tooltip",
                "mouseenter",
                {
                    useContentExp: true
...
angular.module("ui.bootstrap.popover", ["ui.bootstrap.tooltip"])
    ...
    [
        "$uibTooltip", function($uibTooltip) {
            return $uibTooltip("uibPopoverTemplate",
                "popover",
                "click",
                {
                    useContentExp: true
    ...
    [
        "$uibTooltip", function($uibTooltip) {
            return $uibTooltip("uibPopoverHtml",
                "popover",
                "click",
                {
                    useContentExp: true
...
angular.module("ui.bootstrap.rating", [])
    ...
    [
        "$scope", "$attrs", "uibRatingConfig", function($scope, $attrs, ratingConfig) {
        ...
        "$parse", function($parse) {
            return {
                ...
                link: function(scope, elm, attrs, tabsetCtrl, transclude) {
                    ...
                    if (attrs.disable) {
                        scope.$parent.$watch($parse(attrs.disable),
                            function(value) {
                    ...
                    if (angular.isUndefined(attrs.index)) {
                        if (tabsetCtrl.tabs && tabsetCtrl.tabs.length) {
                            scope.index = Math.max
                                .apply(null, tabsetCtrl.tabs.map(function(t) { return t.index; })) +
                                1;
                        } else {
                            scope.index = 0;
                        }
...
angular.module("ui.bootstrap.timepicker", [])
    ...
    [
        ...
        function($scope, $element, $attrs, $parse, $log, $locale, timepickerConfig) {
            ...
            if ($attrs.hourStep) {
                watchers.push($scope.$parent.$watch($parse($attrs.hourStep),
                    function(value) {
                        hourStep = +value;
                    }));
            }
            ...
            if ($attrs.minuteStep) {
                watchers.push($scope.$parent.$watch($parse($attrs.minuteStep),
                    function(value) {
                        minuteStep = +value;
                    }));
            }
            ...
            var min;
            watchers.push($scope.$parent.$watch($parse($attrs.min),
                function(value) {
            ...
            var max;
            watchers.push($scope.$parent.$watch($parse($attrs.max),
                function(value) {
                    var dt = new Date(value);
            ...
            var disabled = false;
            if ($attrs.ngDisabled) {
                watchers.push($scope.$parent.$watch($parse($attrs.ngDisabled),
                    function(value) {
                        disabled = value;
                    }));
            }
            ...
            if ($attrs.secondStep) {
                watchers.push($scope.$parent.$watch($parse($attrs.secondStep),
                    function(value) {
                        secondStep = +value;
                    }));
            }
            ...
            if ($attrs.showSeconds) {
                watchers.push($scope.$parent.$watch($parse($attrs.showSeconds),
                    function(value) {
            ...
            if ($attrs.showMeridian) {
                watchers.push($scope.$parent.$watch($parse($attrs.showMeridian),
                    function(value) {
            ...
            this.setupMousewheelEvents = function(hoursInputEl, minutesInputEl, secondsInputEl) {
                ...
                hoursInputEl.bind("mousewheel wheel",
                    function(e) {
                        if (!disabled) {
                ...
                minutesInputEl.bind("mousewheel wheel",
                    function(e) {
                        if (!disabled) {
                ...
                secondsInputEl.bind("mousewheel wheel",
                    function(e) {
                        if (!disabled) {
    ...
    [
        "uibTimepickerConfig", function(uibTimepickerConfig) {
            return {
 ...
 */
    ...
    [
        "$scope", "$element", "$attrs", "$compile", "$parse", "$q", "$timeout", "$document", "$window", "$rootScope",
        "$$debounce", "$uibPosition", "uibTypeaheadParser",
    ...
    [
        "$templateRequest", "$compile", "$parse", function($templateRequest, $compile, $parse) {
            return {
                scope: {
                    index: "=",
                    match: "=",
    ...
    [
        "$sce", "$injector", "$log", function($sce, $injector, $log) {
...
angular.module("ui.bootstrap.carousel").run(function() {
    !angular.$$csp().noInlineStyle &&
        ...
        .prepend('<style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style>');
...
angular.module("ui.bootstrap.datepicker").run(function() {
    !angular.$$csp().noInlineStyle &&
        ...
        angular.element(document).find("head")
        .prepend('<style type="text/css">.uib-datepicker .uib-title{width:100%;}.uib-day button,.uib-month button,.uib-year button{min-width:100%;}.uib-left,.uib-right{width:100%}</style>');
...
angular.module("ui.bootstrap.datepickerPopup").run(function() {
    !angular.$$csp().noInlineStyle &&
        ...
        angular.element(document).find("head")
        .prepend('<style type="text/css">.uib-datepicker-popup.dropdown-menu{display:block;float:none;margin:0;}.uib-button-bar{padding:10px 9px 2px;}</style>');
