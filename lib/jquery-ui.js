        ...
        _autoSize: function(inst) {
            if (this._get(inst, "autoSize") && !inst.inline) {
                ...
                if (dateFormat.match(/[DM]/)) {
                    ...
                    date.setMonth(findMax(this
                        ._get(inst, (dateFormat.match(/MM/) ? "monthNames" : "monthNamesShort"))));
        ...
        _hideDatepicker: function(input) {
            ...
            if (this._datepickerShowing) {
                ...
                if ($.effects && ($.effects.effect[showAnim] || $.effects[showAnim])) {
                    ...
                    inst
                        .dpDiv[(showAnim === "slideDown" ? "slideUp" : (showAnim === "fadeIn" ? "fadeOut" : "hide"))
...
// return an effect options object for the given parameters:
        function _normalizeArguments(effect, options, speed, callback) {
            ...
            effect.duration = $.fx.off
                ? 0
                : typeof speed === "number" ? speed : speed in $.fx.speeds ? $.fx.speeds[speed] : $.fx.speeds._default;
                    ...
                    this.handles.each(function(i) {
                        ...
                        if (that.options.range === true) {
                            if (that.orientation === "horizontal") {
                                if (i === 0) {
                                    that.range
                                        .stop(1, 1)[animate ? "animate" : "css"]({ left: valPercent + "%" }, o.animate);
                                }
                                if (i === 1) {
                                    that
                                        .range[animate ? "animate" : "css"
...
//Execute the drag once - this causes the helper not to be visible before getting its correct position
                ...
                if (this.options.scroll) {
                    if (this.scrollParent[0] !== this.document[0] && this.scrollParent[0].tagName !== "HTML") {
                        ...
                        if ((this.overflowOffset.left + this.scrollParent[0].offsetWidth) - event.pageX <
                            o.scrollSensitivity) {
                            this.scrollParent[0]
                                .scrollLeft = scrolled = this.scrollParent[0].scrollLeft + o.scrollSpeed;
            ...
            _clear: function(event, noPropagation) {
                ...
                if ((this.fromOutside ||
                    ...
                    !noPropagation) {
                    delayedTriggers
                        .push(function(event) { this._trigger("update", event, this._uiHash()); });
